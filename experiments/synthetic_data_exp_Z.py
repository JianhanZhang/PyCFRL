...
def run_exp_Z(rep, f_x0, f_xt, f_rt, start_seed=1, export=False):
    NREP = rep
    ...
    if export:
        df_n.to_csv('./experiments/synthetic_data_results/results_exp_Z_test.csv')
...
# Run the experiments
df_n = run_exp_Z(rep=50, f_x0=f_x0, f_xt=f_xt, f_rt=f_rt, start_seed=1, export=True)
print(df_n)